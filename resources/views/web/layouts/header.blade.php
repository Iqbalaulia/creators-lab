            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="header-contact">
                        <ul>
                            <li class="text-white">Welcome to Creators Lab</li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-6 text-end">
                    <ul class="header-dropdown">
                        <li class="mobile-wishlist text-white"><a href="#"><i class="fa fa-heart text-white"
                        ...
                        <div class="icon-nav">
                            <ul>
                                <li class="onhover-div mobile-search">
                                    <div><img src="{{ asset('assets/web/images/icon/search.png') }}"
                                ...
                                <li class="onhover-div mobile-setting">
                                    <div><img src="{{ asset('assets/web/images/icon/setting.png') }}"
